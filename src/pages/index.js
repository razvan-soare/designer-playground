      ...
      >
        ...
        <div className="container w-3/4 sm:w-7/12 lg:w-5/12 xl:1/4 mt-10 self-start">
          ...
          >
            ...
            <div className="flex-initial mt-6 sm:mt-0">
              <Link to="/contact">
                <button className="py-2 px-4 bg-indigo-700 hover:bg-indigo-600 text-base text-white font-bold uppercase rounded shadow-md hover:-translate-1">
                  Contact
                </button>
              </Link>
            </div>
        ...
        <div className="flex flex-col mt-10 md:mt-16">
          ...
          <div className="self-center mt-8">
            <Link to="/services">
              <button classnName="py-2 px-4 bg-indigo-700 hover:bg-indigo-600 text-base text-white font-bold uppercase rounded shadow-md hover:-translate-1">
                View all services
              </button>
            </Link>
          </div>
