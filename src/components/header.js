...
const HeaderLink = ({ children, ...props }) => {
  return (
    <div className="flex px-1">
      <Link
        className="w-full md:w-auto py-2 md:px-1 -mb-1 text-sm font-medium uppercase hover:text-indigo-500 border-transparent border-b-4 md:hover:border-indigo-600 relative"
        {...props}
